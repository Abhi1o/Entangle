...
async function main() {
  console.log("🧪 Starting Sepolia final comprehensive test...\n");
  ...
  try {
    ...
    // Test 2: Check and fix ownership if needed
    console.log("🔄 Test 2: Checking ownership...");
    const currentOwner = await contract.owner();
    console.log(`   Current Owner: ${currentOwner}`);
    
    let auctionCreator = bidder1; // Default to bidder1 for creating auctions
    
    if (currentOwner.toLowerCase() !== bidder1.address.toLowerCase()) {
      console.log("   ⚠️  Ownership needs to be transferred to Bidder 1...");
      ...
      console.log("   ✅ Bidder 1 is already the owner!\n");
    }

    // Test 3: Create an auction
    console.log("📝 Test 3: Creating an auction...");
    ...
    const createTx = await contract.connect(auctionCreator).createAuction(
      auctionCreator.address, // host
      "test_sepolia_final", // twitter ID
      duration,
      reservePrice,
      "QmTestSepoliaFinal", // metadata IPFS hash
      meetingDuration,
      { gasLimit: 200000 }
    );
    ...
    // Test 10: Check balances AFTER testing
    console.log("💰 Test 10: Account Balances (AFTER)...");
    ...
    console.log("🎉 Sepolia final comprehensive test completed successfully!");
    console.log("📝 Test results:");
    console.log("   ✅ Contract state verification");
    console.log("   ✅ Ownership management working");
    ...
    console.log("   ✅ Meeting access system ready");
