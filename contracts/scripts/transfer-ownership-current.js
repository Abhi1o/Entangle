...
async function main() {
  console.log("🔄 Starting ownership transfer to current Para wallet...");

  // Contract address
  const CONTRACT_ADDRESS = "0xA514E844fe0a671D07d35B2897F6523C09cD9ecC";
  
  // New owner address (current Para wallet from error)
  const NEW_OWNER = "0x50AEaEcFD1aCCAEA7E26866793D44D2FcDE75e22";
